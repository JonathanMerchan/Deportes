...
namespace Presentacion.Pages.CEncuentro
{
    public class EditarModel : PageModel
    {
        ...
        // Constructor
        public EditarModel(IRepositorioEncuentro repoencu, IRepositorioTorneo repoTorneo, IRepositorioPersona repoperso, IRepositorioCancha repocancha)
        {
        ...
        {
            bool funciono = _repoencu.ActualizarEncuentro(ObjEncuentro);
            if (funciono)
            {
                return RedirectToPage("./Index");
            }
